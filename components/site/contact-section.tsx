...
export function ContactSection() {
  return (
    ...
    >
      ...
      />
      <div aria-hidden className="absolute inset-0 bg-black/60 lg:bg-linear-to-r lg:from-black/90 lg:via-black/55 lg:to-black/10" />
      <div className="relative mx-auto flex min-h-[480px] max-w-7xl items-center px-5 py-20 sm:px-8 sm:py-24 lg:min-h-[520px]">
        ...
        <div className="max-w-2xl">
          <Pill className="border-white/25 bg-black/30">Contactez-nous</Pill>
          <h2 id="contact-heading" className="font-heading mt-6 text-4xl leading-[1.1] font-extrabold text-balance sm:text-5xl lg:text-6xl">
            Le prochain pas,
            <br />
            <span className="text-(--site-accent)">faisons-le ensemble.</span>
          </h2>
          <p className="mt-5 max-w-xl text-sm leading-relaxed text-balance text-(--site-muted) sm:text-base">
            Une question sur l&apos;académie, une journée de détection ou un projet de
            partenariat ? Échangeons autour de votre ambition.
          </p>
          <Link
            href="/contact"
