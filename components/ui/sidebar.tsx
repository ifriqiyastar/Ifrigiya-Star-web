      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>{i18n.t("Navigation mobile")}</SheetTitle>
            <SheetDescription>{i18n.t("Afficher la navigation mobile.")}</SheetDescription>
          </SheetHeader>
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      <PanelLeftIcon />
      <span className="sr-only">{i18n.t("Afficher ou masquer la navigation")}</span>
    </Button>
  )
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label={i18n.t("Afficher ou masquer la navigation")}
      tabIndex={-1}
      onClick={toggleSidebar}
      title={i18n.t("Afficher ou masquer la navigation")}
      className={cn(
